...
from src.config import button_styles
...
def lanzar_menu_principal():
    ...
    tk.Button(root, text="📂 Explorador de Archivos", command=crear_ventana_explorador, **button_styles.config_boton).pack(pady=10)
